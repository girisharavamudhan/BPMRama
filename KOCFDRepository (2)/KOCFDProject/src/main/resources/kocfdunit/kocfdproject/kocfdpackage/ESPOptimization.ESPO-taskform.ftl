<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("attachment");
					i++;
					myInputs[i] = document.getElementById("pecomments");
					i++;
					myInputs[i] = document.getElementById("recomments");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid attachment");
							myInputs[j].focus();
							return false;
						}
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid pecomments");
							myInputs[j].focus();
							return false;
						}
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid recomments");
							myInputs[j].focus();
							return false;
						}
					j++;
	...
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="attachment" type="text" class="textbox" id="attachment" value="" />
                            		</div>
              	
                            		<label for="name">pecomments</label>
                            		<div class="div_texbox">
                              		<input name="pecomments" type="text" class="textbox" id="pecomments" value="" />
                            		</div>
              	
                            		<label for="name">recomments</label>
                            		<div class="div_texbox">
                              		<input name="recomments" type="text" class="textbox" id="recomments" value="" />
                            		</div>
